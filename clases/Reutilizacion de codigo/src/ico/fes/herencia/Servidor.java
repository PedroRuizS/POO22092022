...
public class Servidor extends Computadora{
   ...
   private int tipoRaid;
    ...
    public Servidor(int numeroFuentesPoder, int numeroTarjetasRed, int tipoRaid, String marca, String modelo, Monitor pantalla, Mouse raton, Teclado tecladin, Procesador cpu) {
        super(marca, modelo, pantalla, raton, tecladin, cpu);
        this.numeroFuentesPoder = numeroFuentesPoder;
        this.numeroTarjetasRed = numeroTarjetasRed;
        this.tipoRaid = tipoRaid;
    }
